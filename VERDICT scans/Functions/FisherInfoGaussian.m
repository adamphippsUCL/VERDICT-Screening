function FisherInfo = FisherInfoGaussian(paramIndx, paramGrid, paramSpacings, scan_params, opts)
...
%         disp(paramSetIndx)
    ...
    elseif params(paramIndx) == max(paramGridFlat(:, paramIndx))
        ...
        partialS = ( simulateSignal(paramsUp, scan_params, opts.modeltype) - simulateSignal(paramsDown, scan_params, opts.modeltype) )/0.001;
